            ...
            {!loading && verified && (
                <div>
                    ...
                    <div className="mt-4">
                        ...
                        <Link className="text-primary border border-primary py-2 px-4 rounded-lg" to="/login">Login page
                        </Link>
                    </div>
                </div>
            )}
            {!loading && !verified && (
                <div>
                    ...
                    <div className="mt-4">
                        ...
                        <Link className="text-primary border border-primary py-2 px-4 rounded-lg" to="/">
                            Go to home page
                        </Link>
                    </div>
                </div>
